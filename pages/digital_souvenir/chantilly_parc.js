...
<h1 class="heading-52">Parc du Château de Chantilly<br></br><i class="edition_text">- Argent 2022 -<br></br>10 000 éditions</i></h1>
<p class="price-text"><i>Prix unitaire: 3€</i></p>
<button onClick={() => Buy_parc_silver()} class="buy-button">Obtenir ce souvenir</button>
</div> 
...
<h1 class="heading-52">Parc du Château de Chantilly<br></br><i class="edition_text">- Or 2022 -<br></br>150 éditions</i></h1>
<p class="price-text"><i>Prix unitaire: 10€</i></p>
<button onClick={() => Buy_parc_gold()} class="buy-button">Obtenir ce souvenir</button>
</div> 
