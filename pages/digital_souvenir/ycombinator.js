...
import Footer from "../../components/footer_yc"



export default function YCgetsouvenir() {

  const [email, setEmail] = useState('');
  const [isClicked, setIsClicked] = useState(false);

  const location = "Ycombinator"
  const image_url = "https://keruprojectwebsite.s3.eu-west-3.amazonaws.com/ycombinator_nft_2023.txt"
  const edition = "Winter batch 2023"
...
<div class="App">  
    ...
    <meta content="YCombinator" property="og:title"></meta>
    <meta content="Ycombinator" property="twitter:title"></meta>
...
<div class="div-yc">
  ...
  <model-viewer src="https://keruprojectwebsite.s3.eu-west-3.amazonaws.com/ycombinator_nft_2023.txt" ar ar-modes="webxr scene-viewer quick-look" camera-controls poster="poster.webp" shadow-intensity="1" exposure="1.11" autoplay>
