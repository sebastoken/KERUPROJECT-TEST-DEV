...
export default function App() {
  ...
  function Create_intent_silver_ge(){
    ...
    fetch("/api/create-payment-intent", {
      ...
      body: JSON.stringify({ items: [{ id: "prod_MB6VwjzU0I9e2v", price :'price_1LSkINF8K11ShNmK57omi946' }] }),
    })
      .then((res) => res.json())
...
<h1 class="heading-52">Les Grandes Écuries du Château de Chantilly<br></br><i class="edition_text">- Argent 2022 -<br></br>10 000 éditions</i></h1>
<p class="price-text"><i>Prix unitaire: 3€</i></p>
<button onClick={() => Buy_ge_silver()} class="buy-button">Obtenir ce souvenir</button>
</div> 
...
<h1 class="heading-52">Les Grandes Écuries du Château de Chantilly<br></br><i class="edition_text">- Or 2022 -<br></br>150 éditions</i></h1>
<p class="price-text"><i>Prix unitaire: 10€</i></p>
<button onClick={() => Buy_ge_gold()} class="buy-button">Obtenir ce souvenir</button>
</div> 
