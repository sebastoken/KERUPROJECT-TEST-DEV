...
export default function App() {
  ...
  function Buy_ge_gold(){
    setShowModal1(true);
    Create_intent_gold_ge()
  }

  function Buy_ge_silver(){
    setShowModal(true);
    Create_intent_silver_ge()
  }



  function Create_intent_silver_ge(){

    fetch("/api/create-payment-intent", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({ items: [{ id: "prod_MPM3WAZCsNrHyJ", price :'price_1LgXLVF8K11ShNmKFZHGBBYP' }] }),
    })
      .then((res) => res.json())
  ...
  function Create_intent_gold_ge(){

    fetch("/api/create-payment-intent", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({ items: [{ id: "prod_MPM2evMGE63arm", price :'price_1LgXKfF8K11ShNmK7xvEUviE' }] }),
    })
      .then((res) => res.json())
      .then((data) => setClientSecret(data.clientSecret));
...
<section class="souvenir_sect">
  ...
  <model-viewer src="https://keruprojectwebsite.s3.eu-west-3.amazonaws.com/stables_silver.glb.txt" ar ar-modes="webxr scene-viewer quick-look" camera-controls shadow-intensity="1" exposure="1.11" autoplay>
...
<h1 class="heading-52">Great Stables of Château de Chantilly<br></br><i class="edition_text">- Silver 2022 -<br></br>10 000 editions</i></h1>
<p class="price-text"><i>Price: 3€</i></p>
<button onClick={() => Buy_ge_silver()} class="buy-button">Get this souvenir</button>
</div> 

<div class="div-start-collect">
<section class="souvenir_sect">
  <div className="souvenir_div">
  <model-viewer src="https://keruprojectwebsite.s3.eu-west-3.amazonaws.com/stables_gold.glb.txt" ar ar-modes="webxr scene-viewer quick-look" camera-controls shadow-intensity="1" exposure="1.11" autoplay>
    <div class="progress-bar hide" slot="progress-bar">
    <div class="update-bar"></div>
    </div>
...
<h1 class="heading-52">Great Stables of Château de Chantilly<br></br><i class="edition_text">- Gold 2022 -<br></br>150 editions</i></h1>
<p class="price-text"><i>Price: 10€</i></p>
<button onClick={() => Buy_ge_gold()} class="buy-button">Get this souvenir</button>
</div> 
