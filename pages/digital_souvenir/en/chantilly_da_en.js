...
<h1 class="heading-52">Bicentenary duc d'Aumale<br></br><i class="edition_text">- Silver 2022 -<br></br>10 000 editions</i></h1>
<p class="price-text"><i>Price: 3€</i></p>
<button onClick={() => Buy_da_silver()} class="buy-button">Get this souvenir</button>
</div> 
...
<h1 class="heading-52">Bicentenary duc d'Aumale<br></br><i class="edition_text">- Gold 2022 -<br></br>150 editions</i></h1>
<p class="price-text"><i>Price: 10€</i></p>
<button onClick={() => Buy_da_gold()} class="buy-button">Get this souvenir</button>
</div> 
